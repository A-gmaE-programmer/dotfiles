...
alias c="clear"
alias t="eza --header --all --git --icons --long --tree --level"

# To customize prompt, run `p10k configure` or edit ~/.p10k.zsh.
[[ ! -f ~/.p10k.zsh ]] || source ~/.p10k.zsh

# Options
setopt extendedglob        # extended filtering?
...
# eza
alias l="eza --header --all --git --icons"
alias ll="eza --header --all --git --icons --long"

# THE FUCK
eval $(thefuck --alias)

# Off screen
alias blank="hyprctl dispatch dpms off"
